...
async function populateChalks(dimensions, backing, frames, instance) {
  try {
    const confJson = fs.readFileSync(`./data/products/chalks.json`)
...
module.exports.populateChalks = populateChalks;
